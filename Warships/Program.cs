...
class Program
{
    ...
    private static void CheckSunk(ref char[,] Board, ref ShipType[] Ships);
    ...
    private static void MakePlayerMove(ref char[,] Board, ref ShipType[] Ships)
    {
        ...
        else
        {
            ...
            {
                case 'A':
                    Console.WriteLine($"An {Ships[0].Name} has been hit");
                    break;
                case 'B':
    ...
    private static void PlayGame(ref char[,] Board, ref ShipType[] Ships)
    {
        ...
        while (GameWon == false)
        {
            ...
            { 
                x++;
                Console.WriteLine($"You have had {x} turn(s)");
            }
        }
    }
